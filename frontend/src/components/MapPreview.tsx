...
// Build the fallback map used when Google Maps is not embedded.
...
export function MapPreview({
  ...
  // Prefer Google Maps when available; otherwise use the custom OpenFreeMap view.
      ...
      <View style={styles.mapFrame}>
        {googleEmbedUrl ? (
          ...
          <WebView
            ...
            javaScriptEnabled
            originWhitelist={['*']}
            source={{ html: mapHtml(validPoints) }}
            style={styles.webView}
          />
        )}
      </View>
